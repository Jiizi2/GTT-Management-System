...
function coerceAuthSessionUser(value) {
    ...
    const accessTier = record.accessTier === "admin" || record.accessTier === "super-admin"
        ? record.accessTier
        : null;
...
export function coerceAuthSession(value) {
    if (!value || typeof value !== "object") {
        return null;
    }
    const record = value;
...
function readRawPersistedSession() {
    if (typeof window === "undefined") {
        return null;
    }
    try {
