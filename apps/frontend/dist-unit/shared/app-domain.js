...
export function createScheduleMeta({ category, time, flightNumber, hotelName, fromHotelName, hotelPickupRequestTime, from, to, cityTourCity, note, transferTrainSummary, }) {
    ...
    const hotelNameSummary = normalizedCategory === "transfer"
...
export function normalizeAgreementCityKey(rawValue) {
...
export function buildItineraryItemFromEditForm(currentItem, form) {
    ...
    const shouldPersistHotelName = form.category === "arrival" ||
