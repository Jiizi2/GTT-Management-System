                              ...
                              {isTransferActivityType(item.category) ? (
                                <>
                                  <div className={infoClassName}>
                                    ...
                                    <p>
                                      Jika antar kota menggunakan kereta cepat, isi waktu kereta dan waktu pickup
                                      stasiun tujuan.
                                    </p>
                                  </div>
                                    ...
                                    <input
                                      ...
                                      onChange={(event) =>
                                        updateBaseTripDraftAtIndex(currentBaseTripStepIndex, (trip) => ({
                                          ...
                                          trainDepartureTime: event.target.checked ? trip.trainDepartureTime : "",
                                          destinationPickupTime: event.target.checked ? trip.destinationPickupTime : "",
                                        }))
                                      }
                                      disabled={!isGroupReadyForItinerary || !item.isEnabled}
                                    />
