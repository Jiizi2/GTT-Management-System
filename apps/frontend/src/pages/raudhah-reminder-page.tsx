...
function ReminderSection({
  ...
  return (
    <>
      ...
      <DialogShell
        isOpen={pendingTasrehAction !== null}
        onClose={() => setPendingTasrehAction(null)}
        title="Konfirmasi Status Tasreh"
        size="sm"
      >
        {pendingTasrehAction && (
          <div className="serene-dialog-body px-5 py-4">
            ...
            <div className="mt-5 flex justify-end gap-2">
              ...
              <Button
                variant="primary"
                size="sm"
                className="tracking-[0.08em] uppercase border-emerald-300/30 bg-emerald-100/90 text-emerald-800 hover:bg-emerald-200 hover:border-emerald-400 dark:border-emerald-800/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:hover:bg-emerald-900/40"
...
export function RaudhahReminderScreen({
  ...
  const copiedTimerRef = useRef<any | null>(null);
